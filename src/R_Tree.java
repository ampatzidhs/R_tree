...
//    public MBR insertRecursive22(Nodes node, Double x, Double y) throws IOException {
//        Insertion insert = new Insertion();
//        if(node.getAllRectangles().get(0).isLeafRect()){//////////////////////////fyllooo
//            String idToPut = insert.chooseRectangle(node, x, y);
//            for(Nodes n: allNodes){
//                if(n.getId().equals(node.getId())){
//                    for(MBR mbr: n.getAllRectangles()){
//                        if(mbr.getId().equals(idToPut)){
//                            LeafRecords newLeaf = new LeafRecords(mbr.getId(), x, y);
//                            if(mbr.fits(MBR.sizeof(n), newLeaf, 1.0)){//////////////xoraei
//                                mbr.periexomeno.add(newLeaf);
//                                ArrayList<Double> newDiast = insert.newCorners(mbr, x, y);
//                                mbr.makeDiastaseisNew();
//                                mbr.diastaseisA.add(newDiast.get(0));
//                                mbr.diastaseisA.add(newDiast.get(1));
//                                mbr.diastaseisB.add(newDiast.get(2));
//                                mbr.diastaseisB.add(newDiast.get(3));
//
//                                //ΕΠΕΙΔΗ ΔΕΝ ΕΓΙΝΕ ΣΠΛΙΤ ΚΑΙ ΤΟ MBR ΤΟ ΕΧΕΙΣ ΒΡΕΙ ΜΕΣΑ
//                                //ΑΠΟ ΤΟ ΝΟΔΕΣ, ΤΟ ΝΟΔΕΣ ΔΕΝ ΧΡΕΙΑΖΕΤΑΙ ΚΑΜΙΑ ΑΝΑΝΕΩΣΗ
//
//                                MBR dummy = new MBR();
//                                dummy.setId("dummy");
...
//                                    forTheNew.add(mbr.periexomeno.get(i));
//                                }
//
//                                mbr.setPeriexomeno(forTheFirst);
//                                toBeAdded.setPeriexomeno(forTheNew);
//
//                                mbr.setNewDiastaseis();
//                                toBeAdded.setNewDiastaseis();
//
//                                if(toBeAdded.fits(MBR.sizeof(n), toBeAdded, 1.0)){
//                                    toBeAdded.setParentID(n.getId());
...
//                                    size = n.allRectangles.size();
//                                    middle = n.allRectangles.size() / 2;
//                                    ArrayList<MBR> forFirstNodes = new ArrayList<>();
//                                    ArrayList<MBR> mbrToBeAdded = new ArrayList<>();
//                                    for(int i=0;i<middle; i++){
//                                        forFirstNodes.add(n.allRectangles.get(i));
//                                    }
//                                    for (int i=middle;i<size-1;i++){
//                                        mbrToBeAdded.add(n.allRectangles.get(i));
//                                    }
//
...
//        ArrayList<MBR> allRects = new ArrayList<>();
//        MBR toPut = new MBR();
//        String idToPut = "";
//        Nodes forTheNext = new Nodes();
//        for(Nodes n:allNodes) {/////////////////an oxi fyllo
//            if (n.getId().equals(node.getId())) {
//                keepN.setId(n.getId());
//                keepN.setParentID(n.getParentID());
//                keepN.setAllRectangles(n.getAllRectangles());
//                idToPut = insert.chooseRectangle(n, x, y);
//                allRects = n.getAllRectangles();
//                toPut = new MBR();
//                forTheNext = new Nodes();
...
//            }
//        }
//        toPut = insertRecursive(forTheNext, x, y);
//        for(Nodes n:allNodes) {/////////////////an oxi fyllo
//            if (n.getId().equals(node.getId())) {
//
//                for (MBR m : n.getAllRectangles()) {
...
//                            return toPut;
//                        }
//                        if (toPut.fits(MBR.sizeof(n), toPut, 1.0)) {
//                            toPut.setParentID(n.getId());
//                            keepN.allRectangles.add(toPut);
...
//                            node_id_count++;
//                            nodeToBeAdded.setId(id);
//                            int size = n.allRectangles.size();
//                            int middle = n.allRectangles.size() / 2;
//                            ArrayList<MBR> forFirstNodes = new ArrayList<>();
//                            ArrayList<MBR> mbrToBeAdded = new ArrayList<>();
//                            for (int i = 0; i < middle; i++) {
//                                forFirstNodes.add(n.allRectangles.get(i));
...
//                            }
//
//                            keepN.setAllRectangles(forFirstNodes);
//                            //n.setAllRectangles(forFirstNodes);
//                            nodeToBeAdded.setAllRectangles(mbrToBeAdded);
//
//
